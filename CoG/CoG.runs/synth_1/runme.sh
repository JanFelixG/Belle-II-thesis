...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/CoG/CoG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e_CoG.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e_CoG.tcl
