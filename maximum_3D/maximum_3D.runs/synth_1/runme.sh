...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/maximum_3D/maximum_3D.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log maximum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source maximum.tcl
