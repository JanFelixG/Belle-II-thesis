...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/Maximum1/Maximum1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e_array_maximum.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e_array_maximum.tcl
