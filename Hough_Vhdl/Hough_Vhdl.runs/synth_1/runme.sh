...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/Hough_Vhdl/Hough_Vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e_Hough.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e_Hough.tcl
