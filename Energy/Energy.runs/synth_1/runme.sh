...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/Energy/Energy.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Energy.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Energy.tcl
