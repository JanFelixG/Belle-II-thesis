...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/neural_test2/neural_test2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log myproject.vdi -applog -m64 -stack 2000 -product Vivado -messageDb vivado.pb -mode batch -source myproject.tcl -notrace
