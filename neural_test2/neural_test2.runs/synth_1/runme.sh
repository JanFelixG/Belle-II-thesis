...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/neural_test2/neural_test2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myproject.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myproject.tcl
