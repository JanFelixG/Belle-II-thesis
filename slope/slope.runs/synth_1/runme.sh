...
HD_PWD='/home/ubhks/masterarbeit_ubhks/git_work/slope/slope.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log slope.vds -m64 -stack 2000 -product Vivado -mode batch -messageDb vivado.pb -notrace -source slope.tcl
